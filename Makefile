...
unit:
	nosetests -v -s --rednose --with-coverage --cover-package=timeless tests/unit

functional:
	nosetests --stop --logging-level=INFO -v -s --with-coverage --cover-package=timeless --rednose tests/functional
